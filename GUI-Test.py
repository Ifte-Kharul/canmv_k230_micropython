...
#    print("""Displays text using LVGL.""")
    ...
    label.set_style_text_font(lv.font), 0)
...
#        star_pyramid(5)
        ...
        while True:
            ...
            diff = time.ticks_diff(current_time, start_time)
            print("Diff is : ",diff)
            if diff >= 1000:  # 5000 milliseconds = 5 seconds
                label.delete()
                print("Text Label Deleted")# Delete the label to make it disappear
                break #exit loop
            lv.task_handler()
#            time.sleep_ms(lv.task_handler())
#        while True: #Keep lvgl running.
#            time.sleep_ms(lv.task_handler())
