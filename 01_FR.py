...
class FaceRecognition:
    def __init__(self,face_det_kmodel,face_reg_kmodel,det_input_size,reg_input_size,database_dir,anchors,confidence_threshold=0.25,nms_threshold=0.3,face_recognition_threshold=0.75,rgb888p_size=[1280,720],display_size=[1920,1080],debug_mode=0,sensor=None):
        # 人脸检测模型路径
        ...
        # Use the provided sensor object
        self.sensor = sensor
        if self.sensor is None:
            raise ValueError("Sensor object must be provided.")
        # 人脸数据库初始化
        self.database_init()
...
#                mp_recording.start_recording(sensor=self.sensor)
                return result
